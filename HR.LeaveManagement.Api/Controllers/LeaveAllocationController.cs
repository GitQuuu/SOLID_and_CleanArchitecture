...
public class LeaveAllocationsController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<List<GetLeaveAllocationDto>>> Get(bool isLoggedInUser = false)
    {
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<GetLeaveAllocationDto>> Get(int id)
    {
        var leaveAllocation = await _mediator.Send(new GetLeaveAllocationDto() { Id = id });
